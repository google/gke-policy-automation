...
test_autoupgrade_for_node_pool_disabled{
    not valid with input as {"Data": {"gke": {"name": "cluster-not-repairing", "node_pools": [{"name": "default", "management": {"auto_repair": true, "auto_upgrade": false }}]}}}
}

test_autoupgrade_for_multiple_node_pools_but_only_one_disabled{
    not valid with input as {"Data": {"gke": {"name": "cluster-not-repairing", "node_pools": [{"name": "default", "management": {"auto_repair": true, "auto_upgrade": true }},{"name": "custom", "management": {"auto_repair": false, "auto_upgrade": false }}]}}}
}
...
test_autoupgrade_for_managment_without_auto_upgrade_field{
    not valid with input as {"Data": {"gke": {"name": "cluster-not-repairing", "node_pools": [{"name": "default", "management": {"auto_repair": true }}]}}}
}