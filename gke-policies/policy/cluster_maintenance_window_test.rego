...
test_cluster_not_configured_maintenance_window if {
    not cluster_maintenance_window.valid with input as {"name": "cluster-not-repairing", "release_channel": {}, "node_pools": [{"name": "default", "management": {"auto_repair": true, "auto_upgrade": true }}]}
}

test_cluster_configured_to_maintanace_window if {
    cluster_maintenance_window.valid with input as {
