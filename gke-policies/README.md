...
|Management|GKE Autopilot mode|GKE Autopilot mode is the recommended way to operate a GKE cluster|[gke-policies/policy/autopilot_cluster.rego](../gke-policies/policy/autopilot_cluster.rego)|
...
|Security|Ensure that node pool locations within Node Auto-Provisioning are covering more than one zone (or not enforced at all)|Node Auto-Provisioning configuration should cover more than one zone|[gke-policies/policy/nap_forbid_single_zone.rego](../gke-policies/policy/nap_forbid_single_zone.rego)|
|Security|Ensure that nodes in Node Auto-Provisioning node pools will use Container-Optimized OS|Nodes in Node Auto-Provisioning should use Container-Optimized OS|[gke-policies/policy/nap_use_cos.rego](../gke-policies/policy/nap_use_cos.rego)|
|Security|Ensure that nodes in Node Auto-Provisioning node pools will use integrity monitoring|Nodes in Node Auto-Provisioning should use integrity monitoring|[gke-policies/policy/nap_integrity_monitoring.rego](../gke-policies/policy/nap_integrity_monitoring.rego)|
...
|Security|Use RBAC Google group|GKE cluster should have RBAC security Google group enabled|[gke-policies/policy/node_rbac_security_group.rego](../gke-policies/policy/node_rbac_security_group.rego)|
