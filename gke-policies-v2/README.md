...
|[Container-Optimized OS](../gke-policies-v2/policy/node_pool_use_cos.rego)|Management|Ensure Container-Optimized OS (cos_containerd) is used for GKE node images|[CIS GKE](https://cloud.google.com/kubernetes-engine/docs/concepts/cis-benchmarks#accessing-gke-benchmark) 1.4: 5.5.1|
...
|[VPC Flow Logs](../gke-policies-v2/policy/intranode_visibility.rego)|Security|Enable VPC Flow Logs and Intranode Visibility|[CIS GKE](https://cloud.google.com/kubernetes-engine/docs/concepts/cis-benchmarks#accessing-gke-benchmark) 1.4: 5.6.1|
